...
export default function LandingPage() {
  const { user } = useAuth();
  const [activePipelineLead, setActivePipelineLead] =
    useState<string>("Stark Industries");
  ...
  const currentLeadData = mockLeads.find(
    (l) => l.name === activePipelineLead,
  ) ||
    mockLeads[0] || {
      name: "",
      contact: "",
  ...
  return (
    <div className="relative min-h-screen bg-black text-neutral-100 overflow-hidden font-sans select-none selection:bg-white selection:text-black">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <Button
                asChild
                variant="outline"
                className="border-zinc-800 hover:bg-zinc-900 text-xs font-semibold tracking-wide uppercase text-zinc-300"
              >
              ...
              <>
                ...
                <Button
                  asChild
                  className="bg-white hover:bg-zinc-200 text-black font-semibold text-xs uppercase tracking-wider active:scale-95 transition-all"
                >
      ...
      <section className="relative container mx-auto px-6 md:px-12 pt-20 pb-24 md:pt-32 md:pb-36 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            >
              Manage prospects, track deals, and unlock conversion speed with
              beautiful, real-time interactive dashboards and robust pipeline
              automation.
            </motion.p>
            ...
            >
              {user ? (
                <Button
                  asChild
                  size="lg"
                  className="bg-white hover:bg-zinc-200 text-black font-semibold text-xs uppercase tracking-wider px-8 shadow-[0_0_20px_rgba(255,255,255,0.08)] active:scale-95 transition-all"
                >
      ...
      <section
        id="features"
        className="py-24 bg-zinc-950 border-t border-zinc-900 relative z-10"
      >
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <p className="text-zinc-400">
              Stop fighting outdated sheets. CRM-X organizes your prospects,
              tracking details, and sales velocity in a unified, beautiful
              client portal.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="text-base font-bold mb-2 text-zinc-100">
                Lead Pipeline
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Add, manage, and delete leads from a high-fidelity dashboard.
                Track company ownership, phone data, and follow-ups.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Sort and narrow leads instantly using status dropdowns, priority
                indices, and custom tag arrays.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Fuzzy search client names, corporate emails, phone numbers, and
                organizations instantly inside your table.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Your data is safe with robust JWT cookie storage, automatic
                token refreshing, and server route authorization middleware.
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-zinc-400 mb-6 leading-relaxed">
                Whether you're a single founder tracking local leads or a
                scaling startup managing millions in deals, CRM-X provides the
                speed, database reliability, and visual clarity required to win.
              </p>
      ...
      <section id="testimonials" className="py-24 z-10 relative">
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <p className="text-zinc-400">
              Discover how founders and sales directors are increasing pipeline
              velocity.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "Converting from complex spreadsheets to CRM-X saved us hours. The UI transitions are unbelievably smooth and keeping track of priority items has never been easier.",
              ...
              {
                quote:
                  "The automated token refresh and secure cookie architecture gave our compliance team peace of mind. Plus, the UI is gorgeous—our team actually loves logging in.",
                author: "Marcus Vance",
              ...
              {
                quote:
                  "I can't imagine running my pipeline without CRM-X. The global search is extremely fast, and the tag management lets me organize warm leads in seconds.",
        ...
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <p className="text-zinc-300 text-xs mb-8 max-w-xs mx-auto uppercase tracking-wider leading-relaxed">
              Get setup in less than two minutes. Bring order to your pipelines
              and start closing leads faster today.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {user ? (
                <Button
                  asChild
                  size="lg"
                  className="bg-white hover:bg-zinc-200 text-black font-bold text-xs uppercase tracking-wider px-8 shadow-[0_0_20px_rgba(255,255,255,0.08)] active:scale-95 transition-all"
                >
                  <Link href="/leads" className="flex items-center gap-2">
                    Enter Dashboard
                    <MoveRight className="w-4.5 h-4.5" />
        ...
        <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-2 font-semibold text-zinc-500">
              © 2026 CRM-X Inc. All Rights Reserved.
            </span>
          </div>
